...
const MONITORAMENTO = new require('asterisk-manager')(logins['MONIT'].port, logins['MONIT'].host, logins['MONIT'].login, logins['MONIT'].password, true);
...
exports.MONITORAMENTO = MONITORAMENTO;